...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_CONTAINER', 'LoadPictureConstants',
           'FONTITALIC', 'FONTNAME', 'FONTUNDERSCORE',
           'OLE_YPOS_HIMETRIC', 'StdFont', 'OLE_YSIZE_PIXELS',
           'OLE_XPOS_CONTAINER', 'OLE_TRISTATE', 'OLE_XSIZE_PIXELS',
           'FONTSIZE', 'Unchecked', 'OLE_YPOS_PIXELS', 'Font',
           'OLE_XPOS_PIXELS', 'OLE_HANDLE', 'OLE_XSIZE_CONTAINER',
           'Default', 'OLE_OPTEXCLUSIVE', 'OLE_ENABLEDEFAULTBOOL',
           'IPictureDisp', 'IFont', 'OLE_COLOR', 'Picture',
           'FONTSTRIKETHROUGH', 'Checked', 'OLE_YSIZE_HIMETRIC',
           'IFontDisp', 'Monochrome', 'VgaColor', 'StdPicture',
           'IPicture', 'Gray', 'OLE_YPOS_CONTAINER', 'FontEvents',
           'OLE_XSIZE_HIMETRIC', 'OLE_CANCELBOOL',
           'OLE_XPOS_HIMETRIC', 'Color', 'FONTBOLD',
           'IFontEventsDisp']
